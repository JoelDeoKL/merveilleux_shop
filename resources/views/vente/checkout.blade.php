			...
			<div class="col-12">
				<div class="bread-inner">
					<ul class="bread-list">
						...
						<li class="active"><a href="{{url('caisse')}}">Paiement</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row"> 
			<div class="col-lg-8 col-12">
				<div class="checkout-form">
					...
					<p>Veuillez remplir tout le formulaire pour un paiement sécurisé</p>
					<!-- Form -->
					<form class="form" method="post" action="#">
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-12">
								<div class="form-group">
									<label>Ville / Province<span>*</span></label>
									<input type="text" name="name" placeholder="" required="required">
								</div>
							</div>
							<div class="col-12">
			...
			<div class="col-lg-4 col-12">
				<div class="order-details">
					...
					<div class="single-widget">
						...
						<div class="content">
							<ul>
								...
								<li>(+) Transaction<span>$1.00</span></li>
								<li class="last">Total<span>$331.00</span></li>
							</ul>
						</div>
					</div>
					<!--/ End Order Widget -->
					...
					<div class="single-widget get-button">
						<div class="content">
							<div class="button">
								<a href="#" class="btn">PROCEDER AU PAIEMENT</a>
							</div>
						</div>
					</div>
					<!--/ End Button Widget -->
